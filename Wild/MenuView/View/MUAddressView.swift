...
class MUAddressView: UIView,UIGestureRecognizerDelegate {
...
//        self.addConstraint(HtAlign)
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(MUAddressView.hadlerCheckImageViewByTap(_:)))
